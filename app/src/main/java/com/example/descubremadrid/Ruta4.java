...
public class Ruta4 extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                destino = Point.fromLngLat(-3.682450396940668,40.424870781979244);//NUESTRA SEÑORA
                intermedio = Point.fromLngLat(-3.6879269788681914, 40.405776605811546);//estacion atocha
                intermedio2 = Point.fromLngLat( -3.692135801974647, 40.41396986027597);//museo prado
                intermedio3 = Point.fromLngLat( -3.6940931558209624, 40.415440939668784);//fuente neptuno
                intermedio4 = Point.fromLngLat(-3.692135801974647, 40.41396986027597);//congreso diputados
                intermedio5 =Point.fromLngLat(-3.6948395693135403, 40.41682476878504);//museo thyssen
                intermedio6=Point.fromLngLat(-3.689373779474947,40.42353059352966);//museo arqueologico


                locationComponent = mapbox.getLocationComponent();
                locationComponent.activateLocationComponent(
                        LocationComponentActivationOptions.builder(Ruta4.this, style).build());
    ...
    private void Ruta() {
        ...
        NavigationRoute.builder(getApplicationContext())
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        if (response.body() == null) {
                            Toast.makeText(Ruta4.this, "error", Toast.LENGTH_LONG).show();
                            return;
                        } else if (response.body().routes().size() < 1) {
                            Toast.makeText(Ruta4.this, "error 2", Toast.LENGTH_LONG).show();
                        ...
                        NavigationLauncher.startNavigation(Ruta4
                                .this, options);
        ...
        builder.setMessage("¿El gps esta desactivado lo desea activar?,Necesita activar el GPS para iniciar la ruta")
                ...
                .setPositiveButton("SI", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(@SuppressWarnings("unused") final DialogInterface dialogInterface, @SuppressWarnings("unused") final int i) {
                        ...
                        locationComponent.activateLocationComponent(
                                LocationComponentActivationOptions.builder(Ruta4.this, loadedMapStyle).build());
