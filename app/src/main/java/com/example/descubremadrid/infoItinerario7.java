...
public class infoItinerario7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_itinerario7);

        btn = findViewById(R.id.buttonRuta7dia);
        if (Build.VERSION.SDK_INT<Build.VERSION_CODES.M){
            btn.setEnabled(true);
        }else{
            Log.i("TAG", "API >=23");
            if (ContextCompat.checkSelfPermission(infoItinerario7.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(infoItinerario7.this, Manifest.permission.ACCESS_FINE_LOCATION)){
                    Log.i("TAG", "Usuario ha rechazado el permiso");

                }else {
                    Log.i("TAG", "Permiso concedido");
                }
                ActivityCompat.requestPermissions(infoItinerario7.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},REQUEST_PERMISSION_LOCA);
            }
        }
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(getApplicationContext(),Ruta7.class);
