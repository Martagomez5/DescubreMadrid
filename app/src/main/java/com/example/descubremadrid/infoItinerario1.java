...
public class infoItinerario1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_info_itinerario1);

        ruta = findViewById(R.id.buttonRuta2dia);
        if (Build.VERSION.SDK_INT<Build.VERSION_CODES.M){
            ruta.setEnabled(true);
        }else{
            Log.i("TAG", "API >=23");
            if (ContextCompat.checkSelfPermission(infoItinerario1.this, Manifest.permission.ACCESS_FINE_LOCATION)== PackageManager.PERMISSION_GRANTED){
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(infoItinerario1.this, Manifest.permission.ACCESS_FINE_LOCATION)){
                    Log.i("TAG", "Usuario ha rechazado el permiso");

                }else {
                    Log.i("TAG", "Permiso concedido");
                }
                ActivityCompat.requestPermissions(infoItinerario1.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION},REQUEST_PERMISSION_LOCA);
            }
        }
