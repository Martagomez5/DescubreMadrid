...
public class Ruta7 extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                destino = Point.fromLngLat(-3.7216514770282347,40.427962408405726);//TELEFERICO
                intermedio = Point.fromLngLat(-3.6632052693135404, 40.432886815473495);//PLAZA LAS VENTAS
                intermedio2 = Point.fromLngLat( -3.6692106597883685, 40.42268038538012);//MUSEO CASA MONEDA
                intermedio3 = Point.fromLngLat(  -3.6977741306864598, 40.423027351076406);//MERCADO SAN ANTON
                intermedio4 = Point.fromLngLat(-3.704051957920033, 40.427172106866145);//PLAZA 2 MAYO
                intermedio5 =Point.fromLngLat( -3.7131994504346024, 40.42701254607744);//PALACIO LIRIA


                locationComponent = mapbox.getLocationComponent();
                locationComponent.activateLocationComponent(
                        LocationComponentActivationOptions.builder(Ruta7.this, style).build());
                ...
                obtenerRutanormal(mapboxMap, origen, destino, intermedio, intermedio2,intermedio3,intermedio4, intermedio5);
    ...
    private void obtenerRutanormal(MapboxMap mapboxMap, Point origenn, Point destinoo, Point intermedioo,Point intermedioo2,Point intermedioo3, Point intermedioo4, Point intermedioo5) {
    ...
    private void obtenerRuta() {
        ...
        NavigationRoute.builder(getApplicationContext())
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        if (response.body() == null) {
                            Toast.makeText(Ruta7.this, "error", Toast.LENGTH_LONG).show();
                            return;
                        } else if (response.body().routes().size() < 1) {
                            Toast.makeText(Ruta7.this, "error 2", Toast.LENGTH_LONG).show();
                        ...
                        NavigationLauncher.startNavigation(Ruta7
                                .this, options);
        ...
        builder.setMessage("¿El gps esta desactivado lo desea activar?,Necesita activar el GPS para iniciar la ruta")
                ...
                .setPositiveButton("SI", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(@SuppressWarnings("unused") final DialogInterface dialogInterface, @SuppressWarnings("unused") final int i) {
                        ...
                        locationComponent.activateLocationComponent(
                                LocationComponentActivationOptions.builder(Ruta7.this, loadedMapStyle).build());
