...
public class Ruta5 extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ruta5);
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(Style.MAPBOX_STREETS, new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                destino = Point.fromLngLat(-3.682450396940668,40.424870781979244);//PARQUE ENRIQUE TIERNO GALVÁN
                intermedio = Point.fromLngLat(-3.6879269788681914, 40.405776605811546);//JARDIN BOTANICO
                intermedio2 = Point.fromLngLat( -3.692135801974647, 40.41396986027597);//MUSEO REINA SOFIA
                intermedio3 = Point.fromLngLat( -3.6940931558209624, 40.415440939668784);//MUSEO FERROCARRIL
                intermedio4 = Point.fromLngLat(-3.692135801974647, 40.41396986027597);//MATADERO MADRID
                intermedio5 =Point.fromLngLat(-3.6948395693135403, 40.41682476878504);//PLANETARIO MADRID


                locationComponent = mapbox.getLocationComponent();
                locationComponent.activateLocationComponent(
                        LocationComponentActivationOptions.builder(Ruta5.this, style).build());
                ...
                ruta(mapboxMap, origen, destino, intermedio, intermedio2,intermedio3,intermedio4, intermedio5);
    ...
    private void ruta(MapboxMap mapboxMap, Point origenn, Point destinoo, Point intermedioo,Point intermedioo2,Point intermedioo3, Point intermedioo4, Point intermedioo5) {
    ...
    private void Ruta() {
        ...
        NavigationRoute.builder(getApplicationContext())
                ...
                .getRoute(new Callback<DirectionsResponse>() {
                    ...
                    public void onResponse(Call<DirectionsResponse> call, Response<DirectionsResponse> response) {
                        if (response.body() == null) {
                            Toast.makeText(Ruta5.this, "error", Toast.LENGTH_LONG).show();
                            return;
                        } else if (response.body().routes().size() < 1) {
                            Toast.makeText(Ruta5.this, "error 2", Toast.LENGTH_LONG).show();
                        ...
                        NavigationLauncher.startNavigation(Ruta5
                                .this, options);
...
// Activate with options
                        locationComponent.activateLocationComponent(
                                LocationComponentActivationOptions.builder(Ruta5.this, loadedMapStyle).build());
